...
import { SearchResult, StateModel } from './state.model';
 ...
 */
function sort(tables: StateModel[], column: string, direction: string): StateModel[] {
    if (direction === '') {
        return tables;
    } else {
...
export class AdvancedService {
    ...
    // tslint:disable-next-line: variable-name
    private _tables$ = new BehaviorSubject<StateModel[]>([]);
    // tslint:disable-next-line: variable-name
    ...
    private _search(): Observable<SearchResult> {
        ...
        // 1. sort
        let tables = sort(StateData, sortColumn, sortDirection);
