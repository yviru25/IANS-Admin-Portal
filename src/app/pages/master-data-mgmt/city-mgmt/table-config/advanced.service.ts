...
import { SearchResult, CityModel } from './city.model';
 ...
 */
function sort(tables: CityModel[], column: string, direction: string): CityModel[] {
    if (direction === '') {
        return tables;
    } else {
...
export class AdvancedService {
    ...
    // tslint:disable-next-line: variable-name
    private _tables$ = new BehaviorSubject<CityModel[]>([]);
    // tslint:disable-next-line: variable-name
    ...
    private _search(): Observable<SearchResult> {
        ...
        // 1. sort
        let tables = sort(CityData, sortColumn, sortDirection);
