...
import { CountryModel, SearchResult } from './country.model';
 ...
 */
function sort(tables: CountryModel[], column: string, direction: string): CountryModel[] {
    if (direction === '') {
        return tables;
    } else {
 ...
 */
function matches(tables: CountryModel, term: string, pipe: PipeTransform) {
    return tables.countryCode.toLowerCase().includes(term)
...
export class AdvancedService {
    ...
    // tslint:disable-next-line: variable-name
    private _tables$ = new BehaviorSubject<CountryModel[]>([]);
    // tslint:disable-next-line: variable-name
