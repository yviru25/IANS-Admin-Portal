...
import { CustomerModel, SearchResult } from './customer.model';
 ...
 */
function sort(tables: CustomerModel[], column: string, direction: string): CustomerModel[] {
    if (direction === '') {
        return tables;
    } else {
 ...
 */
function matches(tables: CustomerModel, term: string, pipe: PipeTransform) {
    return tables.customerName.toLowerCase().includes(term)
}
...
export class AdvancedService {
    ...
    // tslint:disable-next-line: variable-name
    private _tables$ = new BehaviorSubject<CustomerModel[]>([]);
    // tslint:disable-next-line: variable-name
